        ...
        <div class="container-fluid">
          ...
          <div class="card table-responsive shadow">
            <table class="table table-striped mb-0">
              ...
              <tbody>
                <?php while($data = $bookListResult->fetch_assoc()) : ?>
                <tr>
                  <td><?=$data['id'] ?></td>
                  <td><?=$data['isbn'] ?></td>
                  <td><?=$data['name'] ?></td>
                  ...
                  ?></td>
                  <td>
                    <a href="https://<?=$_SERVER['SERVER_NAME'] ?>/dashboard/books/show.php?id=<?=$data['id'] ?>" class="btn btn-info">Detail</a>
                    <a href="https://<?=$_SERVER['SERVER_NAME'] ?>/dashboard/books/borrow.php?id=<?=$data['id'] ?>" onclick="confirmBooking(event, this)" class="btn<?=$data['availability'] !== 'available' ? ' disabled ' : ' ' ?>btn-primary">Borrow Now</a>
                  </td>
                </tr>
                <?php endwhile; ?>
              </tbody>
