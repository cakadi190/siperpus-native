...
// Count borrowed book
$countBorrow = $db->getConnection()->prepare("SELECT * FROM borrowers WHERE borrower_id = ?");
$countBorrow->bind_param("s", $user['id']);
$countBorrow->execute();
$countBorrowResult = $countBorrow->get_result()->num_rows;

// Count penalties book
$countPenalties = $db->getConnection()->prepare("SELECT * FROM penalties WHERE borrower_id = ?");
$countPenalties->bind_param("s", $user['id']);
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-xl-4 col-md-6 mb-4">
              <a href="https://<?=$_SERVER['SERVER_NAME'] ?>/dashboard/my-borrows" class="card border-left-primary text-decoration-none text-dark shadow h-100 py-2">
                <div class="card-body">
            ...
            <!-- Total Books -->
            <div class="col-xl-4 col-md-6 mb-4">
              <a href="https://<?=$_SERVER['SERVER_NAME'] ?>/dashboard/books" class="card border-left-success text-decoration-none text-dark shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
            ...
            <!-- Total Books -->
            <div class="col-xl-4 col-md-6 mb-4">
              <a href="https://<?=$_SERVER['SERVER_NAME'] ?>/dashboard/my-penalties" class="card border-left-danger text-decoration-none text-dark shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
