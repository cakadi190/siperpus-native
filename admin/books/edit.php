...
<head>
  ...
  <title>Edit Book List - Siperpus</title>
...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Add New Books</h1>
            <a href="https://<?=$_SERVER['SERVER_NAME'] ?>/admin/books" class="btn btn-primary btn-sm">Back</a>
          </div>

          <!-- Content Wrapper -->
          <div class="card table-responsive shadow">
            <div class="card-header">
              <h5 class="py-2 mb-0">Edit Data</h5>
            </div>
            <div class="card-body">
              <form action="https://<?=$_SERVER['SERVER_NAME'] ?>/admin/books/update.php?id=<?=$bookData['id'] ?>" method="POST">
                <div class="row mb-3">
                  <div class="col-md-3 text-left text-md-right">
                    <label for="name">Book Name</label>
                  </div>
                  <div class="col-md-9">
                    <input type="text" class="form-control" placeholder="Malin Kundang" value="<?=$bookData['name'] ?>" name="name" id="name" />
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-md-3 text-left text-md-right">
                  ...
                  <div class="col-md-9">
                    <input type="text" class="form-control" placeholder="978-XXXX-XXX-XXXX" value="<?=$bookData['isbn'] ?>" name="isbn" id="isbn" />
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-md-3 text-left text-md-right">
                    <label for="availability">Book Availbility</label>
                  </div>
                  <div class="col-md-9">
                    <select name="availability" id="availability" class="form-control">
                      <option disabled="disabled">Select One</option>
                      <option <?=$bookData['availability'] === 'available' ? 'selected' : 'false'; ?> value="available">Available</option>
                      <option <?=$bookData['availability'] === 'borrowed' ? 'selected' : 'false'; ?> value="borrowed">Borrowed</option>
                    </select>
                  </div>
                </div>
                <div class="row mb-3">
                  ...
                  <div class="col-md-9">
                    <textarea type="text" rows="5" class="form-control" placeholder="Lorem ipsum...." name="description" id="description"> value="<?=$bookData['description'] ?>"</textarea>
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-md-3 text-left text-md-right">
                  ...
                  <div class="col-md-9">
                    <input type="text" class="form-control" placeholder="PT. Penerbit Airlangga" name="publisher" value="<?=$bookData['publisher'] ?>" id="publisher" />
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-md-3 text-left text-md-right">
                  ...
                  <div class="col-md-9">
                    <input type="text" class="form-control" placeholder="Yayasan Mitra Netra" name="writer" id="writer" value="<?=$bookData['writer'] ?>" />
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-9">
                    <button type="submit" class="btn btn-primary me-auto">Edit Book Data</button>
                  </div>
                </div>
              </form>
            </div>
  ...
  <script>
    function confirmBooking(e, b) {
      e.preventDefault();
      if(confirm("Do you wanna to delete this book?")) window.location.href = b.getAttribute('href');
    }
  </script>
