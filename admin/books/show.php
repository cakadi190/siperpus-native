          ...
          <div class="card table-responsive shadow">
            <div class="card-header bg-white align-items-center py-3 d-flex justify-content-between">
              ...
              <div class="d-flex gap-2">
                <a href="https://<?=$_SERVER['SERVER_NAME'] ?>/admin/books" class="btn btn-light">Back</a>
                <a href="https://<?=$_SERVER['SERVER_NAME'] ?>/admin/books/edit.php?id=<?=$bookData['id'] ?>" class="btn btn-warning">Edit</a>
                <a href="https://<?=$_SERVER['SERVER_NAME'] ?>/admin/books/delete.php?id=<?=$bookData['id'] ?>" onclick="confirmBooking(event, this)" class="btn btn-danger">Delete</a>
              </div>
            </div>
