...
<head>
  ...
  <title>Book List - Siperpus</title>
        ...
        <div class="container-fluid">
          ...
          <div class="card table-responsive shadow">
            <div class="card-header">
              <h5 class="py-2 mb-0">Create New Data</h5>
            </div>
            <div class="card-body">
              <form action="https://<?=$_SERVER['SERVER_NAME'] ?>/admin/books/insert.php" method="POST">
                <div class="row mb-3">
                  <div class="col-md-3 text-left text-md-right">
                    <label for="name">Book Name</label>
                  </div>
                  <div class="col-md-9">
                    <input type="text" class="form-control" placeholder="Malin Kundang" name="name" id="name" />
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-md-3 text-left text-md-right">
                  ...
                  <div class="col-md-9">
                    <input type="text" class="form-control" placeholder="978-XXXX-XXX-XXXX" name="isbn" id="isbn" />
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-md-3 text-left text-md-right">
                  ...
                  <div class="col-md-9">
                    <textarea type="text" rows="5" class="form-control" placeholder="Lorem ipsum...." name="description" id="description"></textarea>
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-md-3 text-left text-md-right">
                  ...
                  <div class="col-md-9">
                    <input type="text" class="form-control" placeholder="PT. Penerbit Airlangga" name="publisher" id="publisher" />
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-md-3 text-left text-md-right">
                  ...
                  <div class="col-md-9">
                    <input type="text" class="form-control" placeholder="Yayasan Mitra Netra" name="writer" id="writer" />
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-9">
                    <button type="submit" class="btn btn-primary me-auto">Add New Book</button>
                  </div>
                </div>
              </form>
            </div>
